...
## Uploading the data
```{r}
pixy_folder <- "/home/gill/Project_2022/Temp_Folder/Pixy_Fst_dxy_pi_DE-RU/data/"
...
m <- pixy_df %>%
  ...
  facet_grid(statistic ~ chromosome, switch = "x", space = "free_x",
             labeller = labeller(statistic = pixy_labeller,
                                 value = label_value))+
  xlab("Chromsome")+
  ylab("Statistic Value")+
